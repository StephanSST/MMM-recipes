 ...
 * Adapted by Stephan Staeheli
 * MIT Licensed.
 */

Module.register("MMM-recipes",{
	...
	defaults: {
		feeds: [
			{
				title: "GuteKueche.ch",
				url: "http://www.gutekueche.ch/rss/wochenrezepte.xml"
			}
		],
	...
	getDom: function() {
		...
		if (this.newsItems.length > 0) {
			...
			var encUrl = document.createElement("div");
			encUrl.innerHTML = "<img height='153' src='" + this.newsItems[this.activeItem].enclosureUrl + "' border=0/>";
			wrapper.appendChild(encUrl);
